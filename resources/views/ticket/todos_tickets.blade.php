...
<div class="card-header">
  <i class="fas fa-table"></i><strong> TODAS AS ORDENS DE SERVIÇO </strong></div>
<div class="card-body">
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-row">
                          <div class="form-group col-md-6 ">
                              ...
                              <select class="form-control" id="nomeClienteTicket" required disabled="false"></select>
                          </div>                        
                          ...
                          <div class="form-group col-md-3 ">
                              ...
                              <input type="hidden" class="form-control" id="dataEntrega" readonly="true">
                          </div> 
                      </div>
                      <div class="form-row">
                          <div class="form-group col-md-5 ">
                              <label for="usuarioTicket" class="control-label">Usuário</label>
                              <select class="form-control" id="usuarioTicket"  disabled="false"></select>
                          </div> 
                          <div class="form-group col-md-4 ">
                              <label for="prioridadeTicket" class="control-label">Prioridade</label>
                              <select class="form-control" id="prioridadeTicket" required disabled="false"></select>
                          </div>           
                          <div class="form-group col-md-3 ">
                              <label for="statusTicket" class="control-label">Status</label>
                              <select class="form-control" id="statusTicket" required disabled="false"></select>
                          </div>
                      </div>  
                        <div class="form-group">
                          <label for="observacaoTicket" class="control-label">Conteúdo</label>
                        <div class="input-group">
                            <textarea class="form-control" id="observacaoTicket" rows="5" required disabled="false"></textarea>
                        </div>
                      </div>
                </div>
...
@section('javascript')
    <script type="text/javascript">
        ...
        function carregarTicket(){ // CARREGA AS INFORMAÇÕES NA TABELA PRINCIPAL
         $.getJSON('/api/tickets', function(ticket){
