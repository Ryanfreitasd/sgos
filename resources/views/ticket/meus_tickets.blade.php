...
<div class="card-header">
  <i class="fas fa-table"></i><strong> ORDENS DE SERVIÇO ATRIBUÍDAS A MIM</strong></div>
<div class="card-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3 ml-auto">
                                    ...
                                    <input type="date" class="form-control" id="dataEntrega" value="2019-12-11">
                            </div> 
                        </div>
                        <div class="form-row">
...
@section('javascript')
    <script type="text/javascript">
        ...
        function carregarTicket(){ // CARREGA AS INFORMAÇÕES NA TABELA PRINCIPAL
          $.getJSON('/api/meus_tickets', function(ticket){
