...
<div class="card-header">
  <i class="fas fa-table"></i><strong> ORDENS DE SERVIÇO PENDENTES </strong></div>
<div class="card-body">
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-row">
                          ...
                          <div class="form-group col-md-3 ">
                              ...
                              <input type="hidden" class="form-control" id="dataEntrega">
                          </div> 
                      </div>
                      <div class="form-row">
                          <div class="form-group col-md-5 ">
                              <label for="usuarioTicket" class="control-label">Usuário</label>
                              <select class="form-control" id="usuarioTicket" ></select>
                          </div> 
...
@section('javascript')
    <script type="text/javascript">
        ...
        function carregarTicket(){ // CARREGA AS INFORMAÇÕES NA TABELA PRINCIPAL
          $.getJSON('/api/tickets_pendentes', function(ticket){
