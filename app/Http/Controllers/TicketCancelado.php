...
class TicketCancelado extends Controller
{
    /**
    ...
    {
        return view('ticket.tickets_cancelados');
    }
    public function index()
    {
        $tic = Ticket::with(['priority', 'status', 'user', 'client'])->where('status_id', '=', 5)->orderByRaw('delivery_date ASC')->get();
