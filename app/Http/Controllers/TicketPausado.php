...
class TicketPausado extends Controller
{
    /**
    ...
    {
        return view('ticket.tickets_pausados');
    }
    public function index()
    {
        $tic = Ticket::with(['priority', 'status', 'user', 'client'])->where('status_id', '=', 2)->orderByRaw('delivery_date ASC')->get();
